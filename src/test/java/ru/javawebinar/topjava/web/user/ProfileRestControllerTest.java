...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void updateDuplicateEmailAndGetError() throws Exception {
        UserTo newUserWithExistingEmail = new UserTo(null, "newName",
                "admin@gmail.com", "password", 1500);
        perform(MockMvcRequestBuilders.put(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(newUserWithExistingEmail)))
                .andDo(print())
    ...
    @Test
    void registerWithValidationError() throws Exception {
