...
<head>
    ...
    <script type="text/javascript" src="webjars/jquery/3.6.4/jquery.min.js" defer></script>
    <script type="text/javascript" src="webjars/bootstrap/4.6.2/js/bootstrap.min.js" defer></script>
    <script type="text/javascript" src="webjars/datatables/1.13.2/js/jquery.dataTables.min.js" defer></script>
    <script type="text/javascript" src="webjars/datatables/1.13.2/js/dataTables.bootstrap4.min.js" defer></script>
