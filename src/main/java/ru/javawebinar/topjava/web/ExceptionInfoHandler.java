...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo notFoundError(HttpServletRequest req, NotFoundException e) {
        return logAndGetErrorInfo(req, e, false,
                DATA_NOT_FOUND, new String[]{messageSourceAccessor.getMessage(EXCEPTION_DATA_NOT_FOUND)});
    }
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        ...
        return logAndGetErrorInfo(req, e, true,
                DATA_ERROR, new String[]{messageSourceAccessor.getMessage(DATA_ERROR.getErrorMessage())});
    }
    ...
    public ErrorInfo validationError(HttpServletRequest req, Exception e) {
        return logAndGetErrorInfo(req, e, false,
                VALIDATION_ERROR, new String[]{messageSourceAccessor.getMessage(VALIDATION_ERROR.getErrorMessage())});
    }
    ...
    public ErrorInfo internalError(HttpServletRequest req, Exception e) {
        return logAndGetErrorInfo(req, e, true,
                APP_ERROR, new String[]{messageSourceAccessor.getMessage(APP_ERROR.getErrorMessage())});
    }
